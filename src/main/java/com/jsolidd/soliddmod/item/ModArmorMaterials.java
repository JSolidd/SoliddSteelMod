...
public enum ModArmorMaterials implements ArmorMaterial {
    SOLIDD_STEEL("solidd_steel", 23, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.5F, 0.0F, () -> {
        return Ingredient.of(ModItems.SOLIDD_STEEL_INGOT.get());
    });
    ...
    public String getName() {return SoliddMod.MOD_ID + ":" + this.name;}
